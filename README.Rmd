...
When you run this function it will load all of the data and create six data frames (actually [`tibble`s](https://tibble.tidyverse.org/), but they work pretty much the same). These are the names of the data frames that are created:
